...
export default function MainPage() {
  ...
  return (
    <div className="max-w-4xl w-full h-125 rounded-lg border bg-white p-7 flex flex-col justify-between">
      <div className="">
        <div className="flex items-center gap-2">
          <StarIcon />
          <h3 className="text-2xl font-semibold">Article Quiz Generator</h3>
        </div>

        <p className="mt-2 text-sm text-zinc-500">
          Paste your article below to generate a summary and then take a quick
          quiz.
        </p>

        <div className="mt-6 flex items-center gap-2">
          <PaperIcon />
          <p className="text-sm font-semibold text-zinc-600">Article Title</p>
        </div>
        ...
        <div className="mt-5 flex items-center gap-2">
          <PaperIcon />
          <p className="text-sm font-semibold text-zinc-600">Article Content</p>
        </div>
        {mode === "input" && (
          <Input2
            className="mt-2 h-40 max-h-40 overflow-y-auto resize-none"
            value={content}
